...
export function needsCompaction(messages, contextWindow = 200000) {
...
export function truncateToolResults(messages, maxCharsPerResult = 10000) {
 ...
 */
export function buildCompactPrompt(messages) {
    const text = messagesToText(messages);
    if (!text)
        return "";
    return ("Summarize this conversation concisely. Preserve key decisions, " +
